...
import { PERFIL, criarMissao, avancarMissao, aplicarDecisao, proximoEvento, estadoParaAvaliacao, pistaNecessariaM, combustivelNecessarioKg, localizarBaloes } from '../public/src/simulacao.js';
