...
describe('estado do JEV piloto', () => {
  ...
  it('com o rumo alinhado, manter mantém a rota e virar afasta; a manobra em curso vem da ordem activa', () => {
    const m = semDiretor();
