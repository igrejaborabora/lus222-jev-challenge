...
describe('classificação dos erros do Gateway', () => {
  it('orçamento, quota e 429 contam como limite, mesmo dentro de um RetryError', () => {
    assert.equal(classificarErro({ name: 'AI_RetryError', lastError: { statusCode: 429 } }), 'limite');
