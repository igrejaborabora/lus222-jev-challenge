...
const linha = (overrides = {}) => ({
  ...
  jev: { fonte: 'jev', answers: { acaoMissao: { choice: 'desviar_alternativo' }, destinoPreferido: { choice: 'stol_proximo' }, manobraVertical: { choice: 'manter' }, manobraLateral: { choice: 'manter' }, precisaRevisaoPIC: { probability: 0.85 } } },
