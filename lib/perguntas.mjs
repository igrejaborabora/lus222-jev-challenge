const CONTEXTO =
  ...
  'No modo piloto contínuo recebes três a cinco obstáculos ordenados e folgas candidatas calculadas localmente; escolhe os eixos que maximizam a folga mínima. ' +
  'Cada resposta fica ligada ao snapshot que a originou e o controlador mantém a última ordem enquanto chegam até dois pedidos em pipeline. ' +
...
export const PERGUNTAS_INCIDENTE = {
  ...
  manobraVertical: {
    ...
    instructions:
      ...
      'Com vários obstáculos, compara geometria.folgas_candidatas e protege a menor folga do corredor, não apenas o primeiro item. ' +
  ...
  manobraLateral: {
    ...
    instructions:
      ...
      'Com vários obstáculos, compara geometria.folgas_candidatas e escolhe a passagem com maior folga mínima. ' +
